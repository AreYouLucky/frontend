  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex h-12 md:h-14 w-full items-center justify-between rounded-2xl border border-white/70  px-6 py-3 text-left text-white  transition hover:bg-white/10"
      >
