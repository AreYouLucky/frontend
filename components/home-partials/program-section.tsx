        ...
        <>
            {programs?.map((program, index) => (
                <div
                    key={index}
                    className="relative"
                    style={{ zIndex: programs.length - index }}
                >
                    {program.episodes && program?.episodes?.length > 0 && (
                        <>
                            <div className="relative">
                                <div className="px-2 lg:px-5 w-full flex flex-row justify-between items-center md:mb-6 mb-2">
                                    ...
                                    <Link
                                        ...
                                        className="font-semibold h-fit rounded-lg px-4 md:py-1.5 py-1 text-[12px] md:text-[15px] border border-white/40 text-white"
                                    >
                                        View All
                                    </Link>
                                </div>
                            ...
                            <div className="lg:px-8 md:px-5 px-5 md:pt-10 md:pb-8 pt-7 pb-4"></div>
                        </>
                    )}
                </div>
            ))}
